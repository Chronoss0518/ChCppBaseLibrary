...
#ifndef CH_BELL_CHARA_FUNCTION
#define CH_BELL_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(ChStd::GetBellChara,type)
#endif
...
#ifndef CH_HTAB_CHARA_FUNCTION
#define CH_HTAB_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(ChStd::GetHTabChara,type)
#endif

#ifndef CH_VTAB_CHARA_FUNCTION
#define CH_VTAB_CHARA_FUNCTION(type) CH_NUMBER_FUNCTION(ChStd::GetVTabChara,type)
#endif
...
CH_TO_NUMBER_FUNCTION(CH_BELL_CHARA_FUNCTION, "\a");
...
CH_TO_NUMBER_FUNCTION(CH_HTAB_CHARA_FUNCTION, "\t");

CH_TO_NUMBER_FUNCTION(CH_VTAB_CHARA_FUNCTION, "\v");
