...
namespace ChCpp
{
	...
	public:
		...
		bool GetTriNearPoint(ChVec3& _hitVector, ChVec3& _normal, const ChVec3& _point, const ChVec3& _pos1, const ChVec3& _pos2, const ChVec3& _pos3, float _maxLen = ChMath::GetMaxFloat());
